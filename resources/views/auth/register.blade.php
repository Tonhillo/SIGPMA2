...
<head>
    ...
    <title>SIGPMA|REGISTRO USUARIOS</title>
...
<div class="register-box">
    <div class="register-logo">
        <p><b>SIGPMA|</b>REGISTRO USUARIOS</p>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            {{-- Recintos --}}
            @if ($errors->has('recinto'))
                <span class="help-block">
                    <strong>{{ $errors->first('recinto') }}</strong>
                </span>
            @endif
            ...
            <!--ROLES  -->
            <!-- Necesario Cargar dinamicamente -->
            <div class="form-group">
        ...
        <button class="btn btn-primary btn-block btn-flat">Volver</button>

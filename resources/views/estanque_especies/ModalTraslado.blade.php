...
<div class="modal fade in" id="ModalTraslado-{{$estanqueEspecie->id}}">
    <div class="modal-dialog"> <!-- Inicio del div del MODAL-DIALOG -->
        ...
        <div class="modal-content"> <!-- Inicio del div del MODAL-CONTENT -->
            ...
            <div class="modal-header">
                <h4 class="modal-title">Trasladar Especie <i class="glyphicon glyphicon-share-alt"></i></h4>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    {!! Form::label('estanqueDestino', 'Seleccione el Estanque De Destino:') !!}
                    {!! Form::select('estanqueDestino', $estanquesDisponiblesTraslado, null, ['class' => 'form-control']) !!}
                    ...
                    {{--Motivo del traslado--}}
                    <label>Describa el motivo del traslado</label>
